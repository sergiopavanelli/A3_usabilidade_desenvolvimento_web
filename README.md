# LoopMarket - Marketplace de Revenda
...
**Curso:** Análise e Desenvolvimento de Sistemas / Ciência da Computação (ou seu curso)
...
## 2. Configuração do Ambiente e Ferramentas (Entrega A3)
...
### 2.2. Recursos e Ferramentas Adicionais
...
- **Sistema de Leilão:** Vendedores podem iniciar leilões; compradores podem dar lances.
